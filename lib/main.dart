...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb){
    await Firebase.initializeApp(options: const FirebaseOptions(
        apiKey: "AIzaSyBl3JdpswAWRYq_uRYb3re4th7zw46srmw",
        ...
        appId: "1:1070944386226:web:9a40740db5fcff40f69dab"
    ));
  } else if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyAZvdYO171fh2VVvGjv2591AvJXoKJ-m9M",
        appId: "1:1070944386226:android:d30cfe3d063e352af69dab",
        messagingSenderId: "1070944386226",
        projectId: "ocass-a1f8f",
      ),
    );
